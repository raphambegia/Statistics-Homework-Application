...
public class viewAssignmentController {
    ...
    public boolean attemptsRemaining() {
        ...
        if(student.getAssignmentBestMark(assignment) != null) {
            int numAttempts = student.getNumAttempts(assignment.getAssignmentName());
    ...
    public void toPracticeAssgn() throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../StudentGUI/practiceAssignment.fxml"));
